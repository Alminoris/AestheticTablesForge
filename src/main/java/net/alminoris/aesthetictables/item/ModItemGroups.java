...
public class ModItemGroups
{
    ...
    public static final CreativeModeTab ATBLS_TAB = new CreativeModeTab(AestheticTables.MOD_ID + ".atblstab") {
        @Override
        public ItemStack makeIcon() {
            return new ItemStack(ModBlocks.TABLES.get("oak").get().asItem());
        }
